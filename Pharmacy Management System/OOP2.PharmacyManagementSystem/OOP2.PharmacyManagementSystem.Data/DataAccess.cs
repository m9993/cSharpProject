...
namespace OOP2.PharmacyManagementSystem.Data
{
    public class DataAccess
    {
        ...
        public static SqlConnection SqlCon
        {
            get
            {
                if (sqlCon == null)
                {
                    sqlCon = new SqlConnection(@"Data Source=DESKTOP-U8B0830\SQLEXPRESS;Initial Catalog=pharmacydb;Persist Security Info=True;User ID=sa;Password=123");
                }
